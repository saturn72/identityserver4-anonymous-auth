...
{
    public class AnonymousAuthorizationRequestValidatorTests
    {
        [Fact]
        public async Task ValidateAsync_ThrowsOnMissingParameters()
        {
            var log = new Mock<ILogger<AnonymousAuthorizationRequestValidator>>();
            ...
            var v = new AnonymousAuthorizationRequestValidator(opt.Object, null, log.Object);
        ...
        [Fact]
        public async Task ValidateAsync_ReturnsError_MissingAnonymousAllowedGrant_ForClient()
        {
            var csvr = new ClientSecretValidationResult
            {
                Client = new Client
        ...
        public async Task ValidateAsync_ReturnsError_InvalidScope_ResourceValidatorFailure(ResourceValidationResult result)
        {
            ...
            var v = new AnonymousAuthorizationRequestValidator(opt.Object, rv.Object, log.Object);
